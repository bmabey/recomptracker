...
class TestPRatioCalculations(unittest.TestCase):
    ...
    def test_bulk_p_ratio_independent_of_bf(self):
        ...
        self.assertLess(ratio_variance, 0.01, "Bulk P-ratios should not vary significantly with body fat")
    ...
    def test_female_bf_thresholds(self):
        ...
        mod_bf_ratio = female_engine._get_p_ratio(PhaseType.CUT, 25)   # Moderate for female
...
class TestPhaseTransitions(unittest.TestCase):
    ...
    def test_cut_first_template_logic(self):
        ...
        self.assertEqual(initial_phase, PhaseType.BULK,
    ...
    def test_bulk_first_template_logic(self):
        ...
        self.assertEqual(initial_phase, PhaseType.BULK,
                        "Bulk-First template should prefer bulking")
    ...
    def test_phase_transition_thresholds(self):
        ...
        should_transition = engine._should_transition_phase(cut_state, PhaseType.CUT, 10)
        self.assertTrue(should_transition, "Should transition from cut to bulk at 19% BF")
        ...
        should_transition = engine._should_transition_phase(bulk_state, PhaseType.BULK, 15)
        self.assertTrue(should_transition, "Should transition from bulk to cut at 24% BF")
    ...
    def test_minimum_phase_durations(self):
        ...
        self.assertFalse(should_transition, "Should not transition from cut before 8 weeks")
        ...
        self.assertFalse(should_transition, "Should not transition from bulk before 12 weeks")
...
class TestGoalDetection(unittest.TestCase):
    ...
    def test_almi_goal_detection(self):
        ...
        high_almi_state = engine._create_initial_state(self.user_profile.scan_history[0])
        ...
        self.assertFalse(goal_achieved, "Low ALMI should not achieve 75th percentile goal")
    ...
    def test_ffmi_goal_detection(self):
        ...
        high_ffmi_state = engine._create_initial_state(self.user_profile.scan_history[0])
        ...
        self.assertFalse(goal_achieved, "Low FFMI should not achieve 90th percentile goal")
...
class TestTrainingVariance(unittest.TestCase):
    ...
    def test_variance_factors(self):
        ...
        for level in TrainingLevel:
            ...
            self.assertEqual(engine.variance_factor, expected_variance,
...
class TestCannedProfiles(unittest.TestCase):
    ...
    def test_novice_overweight_male(self):
        ...
        self.assertGreaterEqual(len(results.trajectories), 50)  # Most runs should complete
        ...
        print(f"Novice overweight male: Goal achieved at week {results.goal_achievement_week}, "
    ...
    def test_novice_lean_female(self):
        ...
        print(f"Novice lean female: Goal achieved at week {results.goal_achievement_week}, "
              f"age {results.goal_achievement_age:.1f}")
    ...
    def test_intermediate_male(self):
        ...
        self.assertEqual(engine.variance_factor, TRAINING_VARIANCE[TrainingLevel.INTERMEDIATE])
        
        print(f"Intermediate male: Goal achieved at week {results.goal_achievement_week}, "
              f"age {results.goal_achievement_age:.1f}")
    ...
    def test_advanced_female(self):
        ...
        self.assertLess(results.goal_achievement_week, 300)  # Up to ~6 years for 95th percentile
        
        # Advanced should have lowest variance
        self.assertEqual(engine.variance_factor, TRAINING_VARIANCE[TrainingLevel.ADVANCED])
        
        print(f"Advanced female: Goal achieved at week {results.goal_achievement_week}, "
              f"age {results.goal_achievement_age:.1f}")
...
class TestStatisticalProperties(unittest.TestCase):
    ...
    def test_simulation_convergence(self):
        ...
        self.assertLess(cv, 0.3, "Simulation results should be reasonably stable across runs")
...
def run_performance_test():
    ...
    print(f"Goal achieved at week {results.goal_achievement_week}, age {results.goal_achievement_age:.1f}")
