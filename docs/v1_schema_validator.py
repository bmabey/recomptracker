...
def validate_v1_url(
    url: str, raise_on_error: bool = True
    ...
    try:
        ...
        is_valid, validation_error = validate_v1_config(
...
def main():
    ...
    if len(sys.argv) < 2:
        ...
        print("Examples:")
        print(
            "  python v1_schema_validator.py 'http://localhost:8501?data=eyJ1Ijp7...'"
        )
    ...
    if arg == "--example":
        ...
        is_valid, error, decoded_config = validate_v1_url(
            test_url, raise_on_error=False
        )
        if is_valid:
            print("✅ Valid V1 URL")
